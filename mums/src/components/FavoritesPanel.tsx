      ...
      {open && (
        <motion.div className="fixed inset-0 z-50" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
          ...
          <motion.aside
            ...
            className="fixed right-4 top-4 z-50 w-[min(420px,calc(100vw-2rem))] rounded-3xl border border-zinc-200 bg-white shadow-xl dark:border-zinc-800 dark:bg-zinc-950"
          >
            ...
            <div className="max-h-[70vh] overflow-y-auto p-4">
              {favorites.length === 0 ? (
                <div className="text-sm text-zinc-500 dark:text-zinc-400">Inga favoriter ännu.</div>
              ) : (
                  ...
                  {favorites.map((m) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="rounded-xl border border-zinc-200 bg-white px-2 py-1 text-sm shadow-sm transition-colors duration-150 hover:bg-zinc-100 dark:border-zinc-800 dark:bg-zinc-900 dark:hover:bg-zinc-800"
